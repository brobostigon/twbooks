...
\item[$\bullet$] 15th - 23rd December 2018, Sainsburys/Adecco, Replenishment:
  \linebreak{}
  Responsabilities include:

\item[$\bullet$] Replenishment of stock on the shop floor, while maintaining health and safety standards and doing correct date rotation on stock

\item[$\bullet$] Management of stock in the warehouse, which includes recieving deliveries as well as returning unreplenished stock back into the warehouse
\linebreak{}
